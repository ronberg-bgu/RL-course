...
def generate_problem(env, problem_path):
    ...
    Key design decisions (matching Omer's approach):
    - `clear` does NOT include agents (agents can share cells for heavy push)
    - `inline` enforces straight-line pushes
    - Boxes already at goals keep their goal; remaining paired with free goals
    """
